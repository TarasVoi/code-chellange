...
const PAGINATON_BASE_URL = "http://localhost:8000/api/posts/pagination";
...
describe("API Tests", () => {
  ...
  /*    test('GET /posts/:id returns a 404 status code for non-existent post', async () => {
      ...
      const response = await axios.get(`http://localhost:8000/api/posts/64e8b7af3tc57bd27ac54f92`);
